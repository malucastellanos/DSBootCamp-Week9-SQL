...
WHERE payment.payment_date > "2005-07-31" AND payment.payment_date < "2005-09-01"
GROUP BY staff_id;
...
SELECT customer.first_name, customer.last_name, customer.email, customer.address_id, address.city_id, city.country_id
FROM customer
